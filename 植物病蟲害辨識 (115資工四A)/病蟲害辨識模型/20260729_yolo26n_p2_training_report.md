...
本次訓練所用資料集為 `Datasets_YOLO26_v5`（8,021 張圖片、25,566 個標註框，8 個病蟲害類別 + 450 張背景負樣本）。完整規模統計、類別分佈與資料工程規範（先切分後增強、介殼蟲降採樣、雙格式導出等），請見〈[Datasets_YOLO26_v5 資料集統計與工程規範報告](../%E8%B3%87%E6%96%99%E9%9B%86%E5%88%86%E6%9E%90/yolo26_v5_dataset_stats.md)〉。
