...
![SSD Small Confusion Matrix](https://app.notion.comdocs/images/ssd_small_confusion_matrix.png)

- PR 曲線對比圖：

![SSD PR Comparison](https://app.notion.comdocs/images/ssd_pr_comparison.png)
